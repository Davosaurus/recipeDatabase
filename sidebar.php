...
<body class="sidebar">
  ...
  <button style="position: absolute; bottom: 0; left: 0; background: none; font-size: 20; font-weight: bold; color: black" onclick="window.open('http://localhost/phpmyadmin/db_structure.php?server=1&db=recipedb');"><span class="icon">⚙</span></button>
</body>