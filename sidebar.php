...
<div class="box-cell edges" style="width: 100%">
    ...
    <button style="position: absolute; bottom: 15%; left: 0; background: none; font-size: 30;" onclick="window.parent.location.href='http://localhost/phpmyadmin/db_structure.php?server=1&db=recipedb';"><b><span class="icon">⚙</span></b></button>
</div>	
</div>	
</div>	
</div>	
